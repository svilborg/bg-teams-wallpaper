...
public class ColorPreference extends DialogPreference implements DialogInterface.OnClickListener {
	...
	private int[] m_colors = { Color.BLACK, Color.DKGRAY, Color.GRAY, Color.LTGRAY, Color.BLUE, Color.GREEN, Color.RED, Color.MAGENTA,  Color.CYAN, Color.YELLOW, Color.WHITE };
